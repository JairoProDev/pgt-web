...
const selectClass =
  "w-full rounded-lg border border-stone-200 bg-stone-50 px-3 py-2.5 text-sm text-stone-800 focus:border-pgt-blue focus:outline-none focus:ring-2 focus:ring-pgt-blue/20";

function IntentField({ label, children }: { label: string; children: React.ReactNode }) {
  return (
