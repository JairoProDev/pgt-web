        ...
        <div className="grid items-center gap-8 lg:grid-cols-[1fr,min(420px,40%)] lg:gap-12">
          <div>
            <p className="text-sm font-semibold uppercase tracking-wide text-pgt-orange">
              Licensed Cusco tour operator since 2012
            </p>
            ...
            <div className="mt-7 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
              ...
              <Link
                href="/packages/"
                className="inline-flex w-full items-center justify-center rounded-lg bg-pgt-orange px-6 py-3 text-sm font-semibold text-white transition hover:opacity-90 sm:w-auto"
              >
                View Peru Packages
              </Link>
              <a
